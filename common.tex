...
\setmonofont[BoldFont={SourceCodePro-Regular},ItalicFont={SourceCodePro-LightIt}]{SourceCodePro-Light}[Scale=0.9]
...
\newcommand{\alternaterowcolors}[1][UGLiBlue]{\rowcolors[]{1}{#1!10}{#1!0}} % to alternate row colors inside tables
\newcommand{\np}{\numprint}
\setlength{\parindent}{0pt}
\renewcommand{\baselinestretch}{1.2}

\newlist{enumalph}{enumerate}{1} % define a new list environment with lettered labels
\setlist[enumalph]{label=\textbf{\alph*.},leftmargin=1.3em}
\setlist[enumerate]{label=\textbf{\arabic*.},leftmargin=*} % beautify enumerate
\setlist[itemize]{label=--,leftmargin=*} % beautify itemize
