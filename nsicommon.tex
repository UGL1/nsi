...
\newlist{enumnoindent}{enumerate}{1}
\setlist[enumnoindent]{label=\textbf{\arabic*.},leftmargin=*}
...
% define the wide equivalent of these environments
\newlist{enumalphw}{enumerate}{1}
\setlist[enumalphw]{label=\textbf{\alph*.},wide}
\newlist{enumeratew}{enumerate}{1}
\setlist[enumeratew]{label=\textbf{\arabic*.},wide}
...
\newenvironment*{encadrecolore}[2]{\begin{modubox}{#1}{#2}}{\end{modubox}}
\newenvironment*{pyc}{\begin{modubox}{Python}{UGLiPurple}}{\end{modubox}}
\newenvironment*{pys}{\begin{modubox}{Python}{UGLiPurple}}{\end{modubox}}
\newenvironment*{sql}{\begin{modubox}{SQL}{UGLiYellow}}{\end{modubox}}
\newenvironment*{html}{\begin{modubox}{HTML}{UGLiGreen}}{\end{modubox}}
\newenvironment*{css}{\begin{modubox}{CSS}{UGLiOrange}}{\end{modubox}}
\newenvironment*{js}{\begin{modubox}{Javascript}{UGLiBlue}}{\end{modubox}}
\newenvironment*{cpp}{\begin{modubox}{C++}{UGLiOrange}}{\end{modubox}}
\newenvironment*{clang}{\begin{modubox}{C}{UGLiOrange}}{\end{modubox}}

% Boxes: various text environments inheriting from modubox
\newcounter{exonumber}
\setcounter{exonumber}{0}
\ifcsname isenglish\endcsname%
  \newenvironment*{definition}[1][]{\begin{modubox}{Definition#1}{UGLiGreen}}{\end{modubox}}
  \newenvironment*{notation}[1][]{\begin{modubox}{Notation#1}{UGLiBlue}}{\end{modubox}}
  \newenvironment*{exemple}[1][]{\begin{modubox}{Example#1}{UGLiYellow}}{\end{modubox}}
  \newenvironment*{propriete}[1][]{\begin{modubox}{Proposition#1}{UGLiRed}}{\end{modubox}}
  \newenvironment*{methode}[1][]{\begin{modubox}{Method#1}{UGLiPurple}}{\end{modubox}}
  \newenvironment*{remarque}[1][]{\begin{modubox}{Remark#1}{UGLiGreen}}{\end{modubox}}
  \newenvironment*{aretenir}[1][]{\begin{modubox}{Note#1}{UGLiGreen}}{\end{modubox}}
  \newenvironment*{attention}[1][]{\begin{modubox}{Warning#1}{UGLiRed}}{\end{modubox}}
  \newenvironment*{demonstration}[1][]{\begin{modubox}{Proof#1}{gray}}{\end{modubox}}
  \newenvironment*{exercice}[1][]
  {\stepcounter{exonumber}\begin{modubox}{Exercise \theexonumber #1}{UGLiOrange}}
      {\end{modubox}}
\else
  ...
  \newenvironment*{attention}[1][]{\begin{modubox}{Attention#1}{UGLiRed}}{\end{modubox}}
...
\newenvironment*{questionnum}[1][]
{\stepcounter{questionnumber}\begin{modubox}{Question \thequestionnumber #1}{UGLiGreen}}
    {\end{modubox}}
