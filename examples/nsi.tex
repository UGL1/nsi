...
\def\abun{label A}
\def\alun{proba A}
\def\abdeux{ label A_barre}
\def\aldeux{ proba A_barre}
\def\abtrois{ label A et B}
\def\altrois{ proba_A(B)}
\def\abquatre{label A et B_barre}
\def\alquatre{ proba_A(B)}
\def\abcinq{ label A_barre et B}
\def\alcinq{ proba_A_barre(B)}
\def\absix{ label A_barre et B_barre}
\def\alsix{ proba_A_barre(B_barre)}
\begin{center}
    \arbreproba
\end{center}
\end{document}
